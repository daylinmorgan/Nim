...
function nimCopy(dest_p0, src_p1, ti_p2) {
  var result_33557300 = null;
    ...
    case 23:
    case 5:
      if (!(isFatPointer__system_u2848(ti_p2))) {
      result_33557300 = src_p1;
      }
      else {
        result_33557300 = [src_p1[0], src_p1[1]];
      }
    ...
    case 19:
      ...
      result_33557300 = dest_p0;
    
      break;
    case 18:
    case 17:
      if (!((ti_p2.base == null))) {
      result_33557300 = nimCopy(dest_p0, src_p1, ti_p2.base);
      }
      else {
      if ((ti_p2.kind == 17)) {
      result_33557300 = (dest_p0 === null || dest_p0 === undefined) ? {m_type: ti_p2} : dest_p0;
      }
      else {
        result_33557300 = (dest_p0 === null || dest_p0 === undefined) ? {} : dest_p0;
      }
      }
      nimCopyAux(result_33557300, src_p1, ti_p2.node);
      break;
    case 4:
    case 16:
        ...
        if (src_p1 === null) {
          ...
          for (var i = 0; i < src_p1.length; ++i) {
            result_33557300[i] = nimCopy(result_33557300[i], src_p1[i], ti_p2.base);
          }
        }
      }
    ...
    case 28:
            if (src_p1 !== null) {
        result_33557300 = src_p1.slice(0);
      }
...
function chckRange(i_p0, a_p1, b_p2) {
  var result_33557340 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557340 = i_p0;
    break BeforeRet;
    }
    else {
    raiseRangeError();
  ...
  return result_33557340;

}

function chckIndx(i_p0, a_p1, b_p2) {
  var result_33557335 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557335 = i_p0;
    break BeforeRet;
    }
    else {
...
function toJSStr(s_p0) {
  var result_33556896 = null;

    var res_33556950 = newSeq__system_u2493((s_p0).length);
    var i_33556951 = 0;
    var j_33556952 = 0;
    Label1: {
        Label2: while (true) {
        if (!(i_33556951 < (s_p0).length)) break Label2;
          var c_33556953 = s_p0[i_33556951];
          if ((c_33556953 < 128)) {
          res_33556950[j_33556952] = String.fromCharCode(c_33556953);
          i_33556951 += 1;
          }
          else {
            var helper_33556978 = newSeq__system_u2493(0);
            Label3: {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33556979 = c_33556953.toString(16);
                  if ((((code_33556979) == null ? 0 : (code_33556979).length) == 1)) {
                  helper_33556978.push("%0");;
                  }
                  else {
                  helper_33556978.push("%");;
                  }
                  
                  helper_33556978.push(code_33556979);;
                  i_33556951 += 1;
                  if ((((s_p0).length <= i_33556951) || (s_p0[i_33556951] < 128))) {
                  break Label3;
                  }
                  
                  c_33556953 = s_p0[i_33556951];
                }
            };
++excHandler;
            try {
            res_33556950[j_33556952] = decodeURIComponent(helper_33556978.join(""));
--excHandler;
} catch (EXCEPTION) {
 var prevJSError = lastJSError;
 lastJSError = EXCEPTION;
 --excHandler;
            res_33556950[j_33556952] = helper_33556978.join("");
    ...
    if (res_33556950.length < j_33556952) { for (var i = res_33556950.length ; i < j_33556952 ; ++i) res_33556950.push(null); }
               else { res_33556950.length = j_33556952; };
    result_33556896 = res_33556950.join("");

  return result_33556896;
...
function raiseException(e_p0, ename_p1) {
    ...
    e_p0.trace = nimCopy(null, rawWriteStackTrace__system_u2166(), NTI33554449);
    throw e_p0;
...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557583 = false;
    F.line = 31;
    var item_33557584 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557583 = item_33557584 !== undefined;
    if (tmp_33557583) {
    F.line = 34;
    result_33557582 = nimCopy(null, makeNimstrLit(item_33557584.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557582 = nimCopy(null, (HEX24__systemZdollars_u8(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557582;
...
function isFatPointer__system_u2848(ti_p0) {
  var result_33557282 = false;

  BeforeRet: {
    result_33557282 = !((ConstSet1[ti_p0.base.kind] != undefined));
    break BeforeRet;
  };
...
function auxWriteStackTrace__system_u2073(f_p0) {
  var result_33556507 = [[]];

    var it_33556515 = f_p0;
    var i_33556516 = 0;
    var total_33556517 = 0;
    var tempFrames_33556518 = arrayConstr(64, {Field0: null, Field1: 0, Field2: null}, NTI33555824);
    Label1: {
        Label2: while (true) {
    ...
    result_33556507[0] = nimCopy(null, [], NTI33554449);
    if (!((total_33556517 == i_33556516))) {
    result_33556507[0].push.apply(result_33556507[0], [40]);;
    result_33556507[0].push.apply(result_33556507[0], HEX24__systemZdollars_u8((total_33556517 - i_33556516)));;
    result_33556507[0].push.apply(result_33556507[0], [32,99,97,108,108,115,32,111,109,105,116,116,101,100,41,32,46,46,46,10]);;
    }
    
    Label5: {
      var j_33556548 = 0;
      var colontmp__654311874 = 0;
      colontmp__654311874 = (i_33556516 - 1);
      var res_654311876 = colontmp__654311874;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_654311876)) break Label7;
            j_33556548 = res_654311876;
            result_33556507[0].push.apply(result_33556507[0], cstrToNimstr(tempFrames_33556518[j_33556548].Field2));;
            if ((0 < tempFrames_33556518[j_33556548].Field1)) {
            result_33556507[0].push.apply(result_33556507[0], [40]);;
            addInt__stdZprivateZdigitsutils_u238(result_33556507, 0, tempFrames_33556518[j_33556548].Field1);
            if (false) {
            result_33556507[0].push.apply(result_33556507[0], [44,32]);;
            addInt__stdZprivateZdigitsutils_u238(result_33556507, 0, 0);
            }
            
            result_33556507[0].push.apply(result_33556507[0], [41]);;
            }
            
            result_33556507[0].push.apply(result_33556507[0], [32,97,116,32]);;
            add__system_u1931(result_33556507, 0, tempFrames_33556518[j_33556548].Field0);
            result_33556507[0].push.apply(result_33556507[0], [10]);;
            res_654311876 -= 1;
          }
      };
    };

  return result_33556507[0];

}

function rawWriteStackTrace__system_u2166() {
  var result_33556599 = [];

    if (!((framePtr == null))) {
    result_33556599 = nimCopy(null, ([84,114,97,99,101,98,97,99,107,32,40,109,111,115,116,32,114,101,99,101,110,116,32,99,97,108,108,32,108,97,115,116,41,10]).concat(auxWriteStackTrace__system_u2073(framePtr)), NTI33554449);
    }
    else {
      result_33556599 = nimCopy(null, [78,111,32,115,116,97,99,107,32,116,114,97,99,101,98,97,99,107,32,97,118,97,105,108,97,98,108,101,10], NTI33554449);
    }
    

  return result_33556599;

}

function newSeq__system_u2493(len_p0) {
  var result_33556929 = [];
  ...
  framePtr = F;
    ...
    result_33556929 = new Array(len_p0); for (var i = 0 ; i < len_p0 ; ++i) { result_33556929[i] = null; }  framePtr = F.prev;
...
function unhandledException(e_p0) {
    ...
    buf_33556644[0].push.apply(buf_33556644[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110,58,32]);;
    buf_33556644[0].push.apply(buf_33556644[0], e_p0.message);;
    }
    else {
    buf_33556644[0].push.apply(buf_33556644[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110]);;
    }
    
    buf_33556644[0].push.apply(buf_33556644[0], [32,91]);;
    add__system_u1931(buf_33556644, 0, e_p0.name);
    buf_33556644[0].push.apply(buf_33556644[0], [93,10]);;
    buf_33556644[0].push.apply(buf_33556644[0], rawWriteStackTrace__system_u2166());;
    var cbuf_33556645 = toJSStr(buf_33556644[0]);
    framePtr = null;
      if (typeof(Error) !== "undefined") {
    throw new Error(cbuf_33556645);
  }
  else {
    throw cbuf_33556645;
  }
